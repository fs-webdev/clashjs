...
//   transform: scale(0.5);
//   animation: ${props =>
//     css`${playv(props.imageHeight)} ${props.duration}s steps(${props.rows}) infinite, ${playh(
//       props.imageWidth
//     )} ${props.duration / props.rows}s steps(${props.columns}) ${props.rows}`}
// }
// `
